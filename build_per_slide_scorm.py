#!/usr/bin/env python3
"""
Build individual SCORM 1.2 packages for each slide/topic in all 5 modules.
Each SCORM package = one topic/slide as a self-contained HTML with:
  - SCORM 1.2 API integration
  - Bilingual English/Arabic with RTL
  - Embedded YouTube videos (intro/conclusion per module)
  - Base64-embedded images (for Module 1)
  - Interactive activities where applicable
  - Quiz per topic
Output: scorm-per-slide/ directory with individual .zip files + full tar.gz
"""
...
OUTPUT_DIR = os.path.join(BASE_DIR, 'scorm-per-slide')
...
# ══════════════════════════════════════════════════════════════
# COURSE CONTENT DEFINITION - All 5 modules with full slide data
# ══════════════════════════════════════════════════════════════
        ...
        'slides': [
            {
                ...
                'image_key': 'module_1',
                'content_en': '''
                    <p class="slide-subtitle">Fundamentals, Types, and the Difference Between Traditional and AI Systems</p>
                    <div class="info-box cyan">
                        <strong>What you will learn:</strong><br>
                        <ul style="margin:8px 0 0 16px">
                            <li>Define what automation means</li>
                            <li>Distinguish between traditional and AI automation</li>
                            <li>Identify the three core types of automation</li>
                        </ul>
                    </div>
                    <div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:8px">
                        <span class="chip">#AutomationBasics</span>
                        <span class="chip">#TraditionalAutomation</span>
                        <span class="chip">#AIAutomation</span>
                        <span class="chip">#TaskAutomation</span>
                        <span class="chip">#ProcessAutomation</span>
                        <span class="chip">#IntelligentAutomation</span>
                    </div>
                ''',
                'content_ar': '''
                    <p class="slide-subtitle">الأساسيات والأنواع والفرق بين الأنظمة التقليدية والذكاء الاصطناعي</p>
                    <div class="info-box cyan">
                        <strong>ما ستتعلمه:</strong><br>
                        <ul style="margin:8px 0 0 16px">
                            <li>تعريف معنى الأتمتة</li>
                            <li>التمييز بين الأتمتة التقليدية وأتمتة الذكاء الاصطناعي</li>
                            <li>تحديد الأنواع الثلاثة الأساسية للأتمتة</li>
                        </ul>
                    </div>
                ''',
                'has_video': True,
            ...
            },
            {
                ...
                'title_ar': 'ما هي الأتمتة؟',
                'type': 'content',
                'image_key': 'automation-concept',
                'content_en': '''
                    <div class="info-box cyan">
                        <strong>Definition:</strong> Automation is the use of technology to perform tasks with minimal human intervention, reducing manual effort and increasing efficiency.
                    </div>
                    <div class="info-box violet" style="margin-top:12px">
                        <strong>Key Aspects of Automation:</strong>
                        <ul style="margin:8px 0 0 16px">
                            <li><strong>Technology-Driven:</strong> Uses software, AI, or machines to execute tasks</li>
                            <li><strong>Minimal Human Intervention:</strong> Reduces or eliminates manual steps</li>
                            <li><strong>Efficiency Focused:</strong> Speeds up processes while reducing errors</li>
                            <li><strong>Scalable:</strong> Can handle increasing workloads without proportional increase in effort</li>
                        </ul>
                    </div>
                    <div class="info-box amber" style="margin-top:12px">
                        <strong>Examples in Healthcare:</strong> Automated appointment reminders, lab result notifications, inventory tracking, patient follow-up emails.
                    </div>
                ''',
                'content_ar': '''
                    <div class="info-box cyan">
                        <strong>التعريف:</strong> الأتمتة هي استخدام التكنولوجيا لأداء المهام بأقل تدخل بشري، مما يقلل الجهد اليدوي ويزيد الكفاءة.
                    </div>
                    <div class="info-box violet" style="margin-top:12px">
                        <strong>الجوانب الرئيسية للأتمتة:</strong>
                        <ul style="margin:8px 0 0 16px">
                            <li><strong>مدفوعة بالتكنولوجيا:</strong> تستخدم البرمجيات أو الذكاء الاصطناعي أو الآلات لتنفيذ المهام</li>
                            <li><strong>أقل تدخل بشري:</strong> تقلل أو تلغي الخطوات اليدوية</li>
                            <li><strong>تركز على الكفاءة:</strong> تسرع العمليات مع تقليل الأخطاء</li>
                            <li><strong>قابلة للتوسع:</strong> يمكنها التعامل مع أحمال عمل متزايدة</li>
                        </ul>
                    </div>
                    <div class="info-box amber" style="margin-top:12px">
                        <strong>أمثلة في الرعاية الصحية:</strong> تذكيرات المواعيد الآلية، إشعارات نتائج المختبر، تتبع المخزون، رسائل المتابعة للمرضى.
                    </div>
                ''',
            },
            {
                ...
                'title_ar': 'لماذا الأتمتة مهمة',
                'type': 'content',
                'image_key': 'why-automation',
                'content_en': '''
                    <div class="info-box cyan">
                        <strong>Why does automation matter?</strong> In modern work environments, automation addresses key challenges:
                    </div>
                    <div class="grid-2" style="margin-top:12px">
                        <div class="info-box emerald"><strong>⏱️ Saves Time</strong><br>Reduces hours spent on repetitive manual tasks</div>
                        <div class="info-box violet"><strong>✅ Reduces Errors</strong><br>Consistent execution without human mistakes</div>
                        <div class="info-box amber"><strong>📈 Increases Productivity</strong><br>Frees staff to focus on higher-value work</div>
                        <div class="info-box cyan"><strong>🔄 Enables Scalability</strong><br>Handles growing workloads without adding staff</div>
                    </div>
                    <div class="info-box slate" style="margin-top:12px">
                        <strong>Healthcare Impact:</strong> Healthcare environments involve repetitive administrative work, manual follow-ups, documentation burden, fragmented communication, and time-sensitive coordination. Automation can help address all of these.
                    </div>
                ''',
                'content_ar': '''
                    <div class="info-box cyan">
                        <strong>لماذا الأتمتة مهمة؟</strong> في بيئات العمل الحديثة، تعالج الأتمتة تحديات رئيسية:
                    </div>
                    <div class="grid-2" style="margin-top:12px">
                        <div class="info-box emerald"><strong>⏱️ توفير الوقت</strong><br>تقليل الساعات المنفقة على المهام اليدوية المتكررة</div>
                        <div class="info-box violet"><strong>✅ تقليل الأخطاء</strong><br>تنفيذ متسق بدون أخطاء بشرية</div>
                        <div class="info-box amber"><strong>📈 زيادة الإنتاجية</strong><br>تحرير الموظفين للتركيز على العمل الأعلى قيمة</div>
                        <div class="info-box cyan"><strong>🔄 تمكين التوسع</strong><br>التعامل مع أحمال العمل المتزايدة بدون إضافة موظفين</div>
                    </div>
                ''',
            },
            {
                ...
                'type': 'content',
                'image_key': 'trad-vs-ai',
                'content_en': '''
                    <div class="grid-2">
                        <div class="info-box violet">
                            <strong>🔧 Traditional Automation</strong><br><br>
                            <ul style="margin-left:16px">
                                <li>Fixed rules: If X, do Y</li>
                                <li>Handles only structured data</li>
                                <li>Rigid, predefined workflows</li>
                                <li>Cannot handle exceptions</li>
                                <li>Good for predictable, repetitive tasks</li>
                            </ul>
                        </div>
                        <div class="info-box emerald">
                            ...
                            <ul style="margin-left:16px">
                                ...
                                <li>Processes unstructured text & images</li>
                                <li>Adaptive decision logic</li>
                                <li>Handles ambiguity and exceptions</li>
                                <li>Learns and improves over time</li>
                            </ul>
                        </div>
                    </div>
                    <div class="info-box amber" style="margin-top:12px">
                        <strong>Key Difference:</strong> Traditional automation follows fixed rules. AI automation can interpret, decide, and adapt — handling complexity and change.
                    </div>
                ''',
                'content_ar': '''
                    <div class="grid-2">
                        <div class="info-box violet">
                            <strong>🔧 الأتمتة التقليدية</strong><br><br>
                            <ul style="margin-right:16px">
                                <li>قواعد ثابتة: إذا حدث X، افعل Y</li>
                                <li>تتعامل مع البيانات المنظمة فقط</li>
                                <li>سير عمل جامد محدد مسبقاً</li>
                                <li>لا تستطيع التعامل مع الاستثناءات</li>
                                <li>جيدة للمهام المتوقعة والمتكررة</li>
                            </ul>
                        </div>
                        <div class="info-box emerald">
                            <strong>🤖 أتمتة الذكاء الاصطناعي</strong><br><br>
                            <ul style="margin-right:16px">
                                <li>معالجة واعية للسياق</li>
                                <li>تعالج النصوص والصور غير المنظمة</li>
                                <li>منطق قرار تكيفي</li>
                                <li>تتعامل مع الغموض والاستثناءات</li>
                                <li>تتعلم وتتحسن مع الوقت</li>
                            </ul>
                        </div>
                    </div>
                ''',
            ...
            {
                'id': 'm1-s5',
                'title': 'Three Types of Automation',
                'title_ar': 'الأنواع الثلاثة للأتمتة',
                'type': 'content',
                'image_key': 'automation-types',
                'content_en': '''
                    <div class="info-box cyan">
                        <strong>Understanding the three core types of automation helps you identify which approach fits different tasks.</strong>
                    </div>
                    <div style="margin-top:12px">
                        <div class="info-box emerald" style="margin-bottom:8px">
                            <strong>1. Task Automation</strong><br>
                            Automates a single, isolated action.<br>
                            <em>Examples: Send confirmation email, create calendar entry, save to spreadsheet.</em>
                        </div>
                        <div class="info-box violet" style="margin-bottom:8px">
                            <strong>2. Process Automation</strong><br>
                            Connects multiple steps into a unified workflow.<br>
                            <em>Examples: HR onboarding flow, order processing pipeline.</em>
                        </div>
                        <div class="info-box amber">
                            <strong>3. Intelligent Automation</strong><br>
                            Combines automation with AI capabilities like predicting, classifying, and recommending.<br>
                            <em>Examples: Classify & route tickets, summarize text, detect anomalies.</em>
                        </div>
                    </div>
                ''',
                'content_ar': '''
                    <div class="info-box cyan">
                        <strong>فهم الأنواع الثلاثة الأساسية للأتمتة يساعدك في تحديد النهج المناسب للمهام المختلفة.</strong>
                    </div>
                    <div style="margin-top:12px">
                        <div class="info-box emerald" style="margin-bottom:8px">
                            <strong>1. أتمتة المهام</strong><br>
                            أتمتة إجراء واحد منفصل.<br>
                            <em>أمثلة: إرسال بريد تأكيد، إنشاء إدخال في التقويم، الحفظ في جدول بيانات.</em>
                        </div>
                        <div class="info-box violet" style="margin-bottom:8px">
                            <strong>2. أتمتة العمليات</strong><br>
                            ربط خطوات متعددة في سير عمل موحد.<br>
                            <em>أمثلة: تدفق تهيئة الموارد البشرية، خط معالجة الطلبات.</em>
                        </div>
                        <div class="info-box amber">
                            <strong>3. الأتمتة الذكية</strong><br>
                            تجمع بين الأتمتة وقدرات الذكاء الاصطناعي مثل التنبؤ والتصنيف والتوصية.<br>
                            <em>أمثلة: تصنيف وتوجيه التذاكر، تلخيص النصوص، اكتشاف الشذوذ.</em>
                        </div>
                    </div>
                ''',
            },
            {
                'id': 'm1-s6',
                'title': 'Task Automation Deep Dive',
                'title_ar': 'أتمتة المهام بالتفصيل',
                'type': 'content',
                'image_key': 'task-automation',
                'content_en': '''
                    <div class="info-box emerald">
                        <strong>Task Automation</strong> automates a single, isolated action — the simplest form of automation.
                    </div>
                    <div class="info-box cyan" style="margin-top:12px">
                        <strong>Characteristics:</strong>
                        <ul style="margin:8px 0 0 16px">
                            <li>Single action, not connected to other steps</li>
                            <li>Rule-based: follows simple if/then logic</li>
                            <li>Quick to set up and easy to maintain</li>
                            <li>Great starting point for automation beginners</li>
                        </ul>
                    </div>
                    <div class="info-box amber" style="margin-top:12px">
                        <strong>Healthcare Examples:</strong>
                        <ul style="margin:8px 0 0 16px">
                            <li>Send appointment confirmation email</li>
                            <li>Create calendar event when booking is made</li>
                            <li>Auto-save patient intake form data to spreadsheet</li>
                            <li>Send reminder SMS 24 hours before appointment</li>
                        </ul>
                    </div>
                ''',
                'content_ar': '''
                    <div class="info-box emerald">
                        <strong>أتمتة المهام</strong> تؤتمت إجراءً واحداً منفصلاً — أبسط أشكال الأتمتة.
                    </div>
                    <div class="info-box cyan" style="margin-top:12px">
                        <strong>الخصائص:</strong>
                        <ul style="margin:8px 0 0 16px">
                            <li>إجراء واحد، غير مرتبط بخطوات أخرى</li>
                            <li>قائم على القواعد: يتبع منطق إذا/ثم بسيط</li>
                            <li>سريع الإعداد وسهل الصيانة</li>
                            <li>نقطة بداية رائعة لمبتدئي الأتمتة</li>
                        </ul>
                    </div>
                ''',
            },
            {
                'id': 'm1-s7',
                'title': 'Process Automation Deep Dive',
                'title_ar': 'أتمتة العمليات بالتفصيل',
                'type': 'content',
                'image_key': 'process-automation',
                'content_en': '''
                    <div class="info-box violet">
                        <strong>Process Automation</strong> connects multiple automated steps into a unified workflow.
                    </div>
                    <div class="info-box cyan" style="margin-top:12px">
                        <strong>Characteristics:</strong>
                        <ul style="margin:8px 0 0 16px">
                            <li>Multiple connected steps in sequence</li>
                            <li>May include conditions and branching</li>
                            <li>Data flows from one step to the next</li>
                            <li>Reduces handoffs between systems and people</li>
                        </ul>
                    </div>
                    <div class="info-box amber" style="margin-top:12px">
                        <strong>Healthcare Example — HR Onboarding:</strong>
                        <ol style="margin:8px 0 0 16px">
                            <li>New employee fills out form → System creates account</li>
                            <li>IT receives notification → Provisions access</li>
                            <li>HR sends welcome packet → Calendar is updated</li>
                            <li>Training modules are assigned → Progress tracking begins</li>
                        </ol>
                    </div>
                ''',
                'content_ar': '''
                    <div class="info-box violet">
                        <strong>أتمتة العمليات</strong> تربط خطوات آلية متعددة في سير عمل موحد.
                    </div>
                    <div class="info-box cyan" style="margin-top:12px">
                        <strong>الخصائص:</strong>
                        <ul style="margin:8px 0 0 16px">
                            <li>خطوات متعددة مترابطة بالتتابع</li>
                            <li>قد تتضمن شروطاً وتفرعات</li>
                            <li>تتدفق البيانات من خطوة إلى التالية</li>
                            <li>تقلل التسليمات بين الأنظمة والأشخاص</li>
                        </ul>
                    </div>
                ''',
            },
            {
                'id': 'm1-s8',
                'title': 'Intelligent Automation Deep Dive',
                'title_ar': 'الأتمتة الذكية بالتفصيل',
                'type': 'content',
                'image_key': 'intelligent-automation',
                'content_en': '''
                    <div class="info-box amber">
                        <strong>Intelligent Automation</strong> combines automation with AI capabilities like understanding, predicting, classifying, and recommending.
                    </div>
                    <div class="info-box cyan" style="margin-top:12px">
                        <strong>AI Capabilities Added:</strong>
                        <ul style="margin:8px 0 0 16px">
                            <li><strong>Understanding:</strong> Reads and interprets unstructured text, images, voice</li>
                            <li><strong>Predicting:</strong> Forecasts outcomes based on patterns in data</li>
                            <li><strong>Classifying:</strong> Categorizes items (e.g., urgent vs routine)</li>
                            <li><strong>Recommending:</strong> Suggests next best actions</li>
                        </ul>
                    </div>
                    <div class="info-box emerald" style="margin-top:12px">
                        <strong>Healthcare Examples:</strong>
                        <ul style="margin:8px 0 0 16px">
                            <li>Classify and route patient support tickets using AI</li>
                            <li>Summarize clinical notes automatically</li>
                            <li>Detect anomalies in lab results</li>
                            <li>Predict no-show risk for appointments</li>
                        </ul>
                    </div>
                ''',
                'content_ar': '''
                    <div class="info-box amber">
                        <strong>الأتمتة الذكية</strong> تجمع بين الأتمتة وقدرات الذكاء الاصطناعي مثل الفهم والتنبؤ والتصنيف والتوصية.
                    </div>
                    <div class="info-box cyan" style="margin-top:12px">
                        <strong>قدرات الذكاء الاصطناعي المضافة:</strong>
                        <ul style="margin:8px 0 0 16px">
                            <li><strong>الفهم:</strong> يقرأ ويفسر النصوص والصور والصوت غير المنظمة</li>
                            <li><strong>التنبؤ:</strong> يتوقع النتائج بناءً على أنماط البيانات</li>
                            <li><strong>التصنيف:</strong> يصنف العناصر (مثل عاجل مقابل روتيني)</li>
                            <li><strong>التوصية:</strong> يقترح أفضل الإجراءات التالية</li>
                        </ul>
                    </div>
                ''',
            },
            {
                ...
                'title_ar': 'ملخص الوحدة الأولى والنقاط الرئيسية',
                'type': 'summary',
                'content_en': '''
                    <div class="info-box cyan">
                        <strong>Key Takeaways:</strong>
                        <ul style="margin:8px 0 0 16px">
                            <li><strong>Automation</strong> = Using technology to perform tasks with minimal human intervention</li>
                            <li><strong>Traditional Automation</strong> follows fixed rules; <strong>AI Automation</strong> adapts and learns</li>
                            <li><strong>Task Automation:</strong> Single actions (send email, save data)</li>
                            <li><strong>Process Automation:</strong> Multi-step workflows (onboarding, order processing)</li>
                            <li><strong>Intelligent Automation:</strong> AI-enhanced (classify, predict, summarize)</li>
                        </ul>
                    </div>
                ''',
                'content_ar': '''
                    <div class="info-box cyan">
                        ...
                        <ul style="margin:8px 0 0 16px">
                            <li><strong>الأتمتة</strong> = استخدام التكنولوجيا لأداء المهام بأقل تدخل بشري</li>
                            <li><strong>الأتمتة التقليدية</strong> تتبع قواعد ثابتة؛ <strong>أتمتة الذكاء الاصطناعي</strong> تتكيف وتتعلم</li>
                            <li><strong>أتمتة المهام:</strong> إجراءات منفردة</li>
                            <li><strong>أتمتة العمليات:</strong> سير عمل متعدد الخطوات</li>
                            <li><strong>الأتمتة الذكية:</strong> معززة بالذكاء الاصطناعي</li>
                        </ul>
                    </div>
                ''',
                'has_video': True,
                'video_type': 'conclusion',
            },
        ],
        'quiz': [
            {'q': 'What is the main purpose of automation?', 'q_ar': 'ما هو الهدف الرئيسي للأتمتة؟',
             'opts': ['To replace all human workers', 'To use technology to perform tasks with minimal human intervention', 'To eliminate technology from workflows', 'To slow down processes'],
             'opts_ar': ['استبدال جميع العمال البشريين', 'استخدام التكنولوجيا لأداء المهام بأقل تدخل بشري', 'إلغاء التكنولوجيا من سير العمل', 'إبطاء العمليات'],
             'correct': 1},
            {'q': 'Which type of automation focuses on a single isolated action?', 'q_ar': 'أي نوع من الأتمتة يركز على إجراء واحد معزول؟',
             'opts': ['Process Automation', 'Intelligent Automation', 'Task Automation', 'Manual Automation'],
             'opts_ar': ['أتمتة العمليات', 'الأتمتة الذكية', 'أتمتة المهام', 'الأتمتة اليدوية'],
             'correct': 2},
            {'q': 'What distinguishes AI automation from traditional automation?', 'q_ar': 'ما الذي يميز أتمتة الذكاء الاصطناعي عن الأتمتة التقليدية؟',
             'opts': ['AI automation is slower', 'AI automation uses context-aware, adaptive logic', 'AI automation only follows fixed rules', 'AI automation requires no technology'],
             'opts_ar': ['أتمتة الذكاء الاصطناعي أبطأ', 'تستخدم منطقاً تكيفياً واعياً للسياق', 'تتبع قواعد ثابتة فقط', 'لا تحتاج تكنولوجيا'],
             'correct': 1},
            {'q': 'Which is an example of Process Automation?', 'q_ar': 'أي مما يلي مثال على أتمتة العمليات؟',
             'opts': ['Sending a confirmation email', 'An HR onboarding workflow connecting multiple steps', 'Classifying support tickets using AI', 'Saving data to a spreadsheet'],
             'opts_ar': ['إرسال بريد تأكيد', 'سير عمل تهيئة الموارد البشرية يربط خطوات متعددة', 'تصنيف تذاكر الدعم بالذكاء الاصطناعي', 'حفظ البيانات في جدول'],
             'correct': 1},
            {'q': 'Intelligent Automation combines automation with:', 'q_ar': 'الأتمتة الذكية تجمع بين الأتمتة و:',
             'opts': ['Manual labor only', 'Fixed rule-based logic only', 'AI capabilities like understanding, predicting, and classifying', 'Hardware upgrades'],
             'opts_ar': ['العمل اليدوي فقط', 'المنطق الثابت القائم على القواعد فقط', 'قدرات الذكاء الاصطناعي مثل الفهم والتنبؤ والتصنيف', 'ترقيات الأجهزة'],
             'correct': 2},
        ],
    },
    # ── MODULE 2: Workflow Thinking ──
    {
        ...
        'slides': [
            ...
            {'id': 'm2-s3', 'title': 'Triggers', 'title_ar': 'المحفزات', 'type': 'content',
             ...
             'content_ar': '<div class="info-box emerald"><strong>المحفز:</strong> الحدث أو الشرط الذي يبدأ سير العمل تلقائياً.</div>'},
            ...
            {'id': 'm2-s5', 'title': 'Conditions', 'title_ar': 'الشروط', 'type': 'content',
             'content_en': '<div class="info-box amber"><strong>Condition:</strong> A checkpoint that evaluates whether certain criteria are met before the process continues.</div><div class="info-box cyan" style="margin-top:12px"><strong>How Conditions Work:</strong><ul style="margin:8px 0 0 16px"><li>Evaluate a yes/no or true/false question</li><li>Route the workflow along different paths</li><li>Enable branching logic</li><li>Handle exceptions and special cases</li></ul></div><div class="info-box emerald" style="margin-top:12px"><strong>Healthcare Example:</strong> Is the preferred appointment slot available? → <strong>Yes:</strong> Confirm booking → <strong>No:</strong> Offer alternatives.</div>',
             'content_ar': '<div class="info-box amber"><strong>الشرط:</strong> نقطة تحقق تقيّم ما إذا كانت معايير معينة مستوفاة قبل أن تستمر العملية.</div>'},
        ...
        'quiz': [
            ...
            {'q': 'What would be the trigger in a patient appointment workflow?', 'q_ar': 'ما هو المحفز في سير عمل مواعيد المرضى؟', 'opts': ['Doctor reviews the chart', 'Patient submits appointment request', 'System sends confirmation', 'Appointment is added to calendar'], 'opts_ar': ['يراجع الطبيب الملف', 'يقدم المريض طلب موعد', 'يرسل النظام تأكيداً', 'يتم إضافة الموعد للتقويم'], 'correct': 1},
            {'q': 'Why is workflow thinking important for automation?', 'q_ar': 'لماذا يعد التفكير بسير العمل مهماً للأتمتة؟', 'opts': ['It makes tasks slower', 'It helps break processes into structured, automatable steps', 'It eliminates the need for technology', 'It only works for simple tasks'], 'opts_ar': ['يجعل المهام أبطأ', 'يساعد في تقسيم العمليات إلى خطوات منظمة قابلة للأتمتة', 'يلغي الحاجة للتكنولوجيا', 'يعمل فقط للمهام البسيطة'], 'correct': 1},
        ],
    },
    # ── MODULE 3: AI Agents ──
    {
        ...
        'slides': [
            ...
            {'id': 'm3-s3', 'title': 'AI Agents vs Standard Automation', 'title_ar': 'وكلاء الذكاء الاصطناعي مقابل الأتمتة العادية', 'type': 'content',
             ...
             'content_ar': '<div class="grid-2"><div class="info-box violet"><strong>الأتمتة العادية</strong><ul style="margin:8px 0 0 16px"><li>تتبع خطوات ثابتة محددة مسبقاً</li><li>لا تستطيع التعامل مع الاستثناءات</li><li>نفس المخرج في كل مرة</li></ul></div><div class="info-box emerald"><strong>وكلاء الذكاء الاصطناعي</strong><ul style="margin:8px 0 0 16px"><li>يمكنهم التفسير واتخاذ القرارات</li><li>يتعاملون مع الغموض والاستثناءات</li><li>يتكيفون بناءً على السياق</li></ul></div></div>'},
            ...
            {'id': 'm3-s5', 'title': 'Goal-Oriented Behavior', 'title_ar': 'السلوك الموجه نحو الهدف', 'type': 'content',
             'content_en': '<div class="info-box emerald"><strong>Goal-Oriented Behavior</strong> means AI agents work toward defined objectives rather than just following fixed rules.</div><div class="info-box cyan" style="margin-top:12px"><strong>How It Works:</strong><ul style="margin:8px 0 0 16px"><li>Agent receives a goal (e.g., "Schedule patient follow-up")</li><li>Evaluates current situation and available options</li><li>Chooses the best path to achieve the goal</li><li>Adapts if the initial approach does not work</li></ul></div><div class="info-box amber" style="margin-top:12px"><strong>Healthcare Example:</strong> An agent tasked with scheduling a follow-up appointment may check the doctor\'s calendar, find no available slots, then automatically check alternative providers or suggest the next available date.</div>',
             'content_ar': '<div class="info-box emerald"><strong>السلوك الموجه نحو الهدف</strong> يعني أن وكلاء الذكاء الاصطناعي يعملون نحو أهداف محددة بدلاً من مجرد اتباع قواعد ثابتة.</div>'},
            {'id': 'm3-s6', 'title': 'Decision Making & Adaptive Execution', 'title_ar': 'اتخاذ القرار والتنفيذ التكيفي', 'type': 'content',
             'content_en': '<div class="info-box violet"><strong>Decision Making:</strong> AI agents can analyze information, weigh options, and choose the best course of action.</div><div class="info-box emerald" style="margin-top:12px"><strong>Adaptive Execution:</strong> AI agents adjust their workflow based on new data and changing conditions.</div><div class="info-box amber" style="margin-top:12px"><strong>Healthcare Example:</strong> An AI agent triaging patient messages can:<ul style="margin:8px 0 0 16px"><li>Prioritize based on urgency keywords</li><li>Route urgent cases directly to on-call physician</li><li>Route routine questions to scheduling system</li><li>Escalate ambiguous cases for human review</li></ul></div>',
            ...
            {'id': 'm3-s12', 'title': 'Module 3 Summary & Key Takeaways', 'title_ar': 'ملخص الوحدة الثالثة', 'type': 'summary', 'has_video': True, 'video_type': 'conclusion',
             'content_en': '<div class="info-box cyan"><strong>Key Takeaways:</strong><ul style="margin:8px 0 0 16px"><li><strong>AI Agents</strong> understand goals, interpret context, and take autonomous actions</li><li>They differ from standard automation by being adaptive and intelligent</li><li>Key capabilities: NLU, goal-oriented behavior, multi-step reasoning, context awareness, tool use</li><li>In healthcare: decision support, triage, referral processing, patient communication</li><li>AI agents support human decisions — they do not replace clinical judgment</li></ul></div>',
             'content_ar': '<div class="info-box cyan"><strong>النقاط الرئيسية:</strong><ul style="margin:8px 0 0 16px"><li><strong>وكلاء الذكاء الاصطناعي</strong> يفهمون الأهداف ويفسرون السياق ويتخذون إجراءات مستقلة</li><li>يختلفون عن الأتمتة العادية بكونهم تكيفيين وذكيين</li><li>القدرات الرئيسية: فهم اللغة الطبيعية، السلوك الموجه نحو الهدف، الاستدلال متعدد الخطوات</li></ul></div>'},
        ],
        'quiz': [
            ...
            {'q': 'What is multi-step reasoning?', 'q_ar': 'ما هو الاستدلال متعدد الخطوات؟', 'opts': ['Running one step repeatedly', 'Breaking complex tasks into sub-tasks and adjusting based on results', 'Only answering yes/no questions', 'Storing data in multiple locations'], 'opts_ar': ['تشغيل خطوة واحدة بشكل متكرر', 'تقسيم المهام المعقدة إلى مهام فرعية والتعديل بناءً على النتائج', 'الإجابة فقط بنعم/لا', 'تخزين البيانات في مواقع متعددة'], 'correct': 1},
        ],
    },
    # ── MODULE 4: Vibe Coding ──
    {
        ...
        'slides': [
            ...
            {'id': 'm4-s2', 'title': 'What is Vibe Coding?', 'title_ar': 'ما هي البرمجة بالوصف؟', 'type': 'content',
             ...
             'content_ar': '<div class="info-box cyan"><strong>البرمجة بالوصف</strong> هي إنشاء حلول رقمية عن طريق وصف ما تريده بلغة طبيعية، ثم ترك الذكاء الاصطناعي يولد الكود. لا تتطلب برمجة تقليدية.</div>'},
            {'id': 'm4-s3', 'title': 'Describe → Generate → Refine', 'title_ar': 'صف ← ولّد ← حسّن', 'type': 'content',
             'content_en': '<div class="info-box cyan"><strong>The Core Loop of Vibe Coding:</strong></div><div style="margin-top:12px"><div class="info-box emerald" style="margin-bottom:8px"><strong>1. Describe</strong><br>Write a clear natural language description of what you want to build. Be specific about features, layout, and functionality.</div><div class="info-box violet" style="margin-bottom:8px"><strong>2. Generate</strong><br>AI reads your prompt and generates the initial code/application. This includes structure, design, and basic logic.</div><div class="info-box amber"><strong>3. Refine</strong><br>Review the output, identify what needs improvement, and provide follow-up prompts to adjust, enhance, or fix the result.</div></div>',
            ...
            {'id': 'm4-s5', 'title': 'Rapid Prototyping with AI', 'title_ar': 'النمذجة السريعة مع الذكاء الاصطناعي', 'type': 'content',
             'content_en': '<div class="info-box emerald"><strong>Rapid Prototyping</strong> means quickly creating working prototypes of ideas using AI tools.</div><div class="info-box cyan" style="margin-top:12px"><strong>Benefits:</strong><ul style="margin:8px 0 0 16px"><li><strong>Speed:</strong> From idea to working prototype in minutes</li><li><strong>Accessibility:</strong> No coding skills required</li><li><strong>Low cost:</strong> Test ideas before investing in full development</li><li><strong>Fast feedback:</strong> Show stakeholders working demos quickly</li><li><strong>Iteration:</strong> Easy to modify and test different approaches</li></ul></div><div class="info-box amber" style="margin-top:12px"><strong>Healthcare Example:</strong> A nurse wants a simple patient feedback form — describes it to an AI tool, gets a working prototype in 5 minutes, shows it to the team, refines based on feedback.</div>',
            ...
            {'id': 'm4-s6', 'title': 'Iteration & Refinement', 'title_ar': 'التكرار والتحسين', 'type': 'content',
             'content_en': '<div class="info-box amber"><strong>Iteration</strong> is the process of repeatedly refining your prompts and the generated output until the solution meets requirements.</div><div class="info-box cyan" style="margin-top:12px"><strong>The Iteration Process:</strong><ol style="margin:8px 0 0 16px"><li>Review the generated output</li><li>Identify what works and what needs improvement</li><li>Write a specific follow-up prompt addressing the issues</li><li>Review the updated output</li><li>Repeat until satisfied</li></ol></div><div class="info-box emerald" style="margin-top:12px"><strong>Tips for Better Iteration:</strong><ul style="margin:8px 0 0 16px"><li>Be specific about what to change</li><li>Focus on one improvement at a time</li><li>Reference specific elements ("make the button larger")</li><li>Test after each iteration</li></ul></div>',
            ...
            {'id': 'm4-s9', 'title': 'Module 4 Summary & Key Takeaways', 'title_ar': 'ملخص الوحدة الرابعة', 'type': 'summary', 'has_video': True, 'video_type': 'conclusion',
             ...
             'content_ar': '<div class="info-box cyan"><strong>النقاط الرئيسية:</strong><ul style="margin:8px 0 0 16px"><li><strong>البرمجة بالوصف:</strong> إنشاء حلول بلغة طبيعية</li><li><strong>الحلقة الأساسية:</strong> صف ← ولّد ← حسّن</li><li><strong>التطوير بالأوامر:</strong> اكتب تعليمات واضحة</li><li><strong>النمذجة السريعة:</strong> من الفكرة إلى النموذج في دقائق</li></ul></div>'},
        ],
        'quiz': [
            {'q': 'What is vibe coding?', 'q_ar': 'ما هي البرمجة بالوصف؟', 'opts': ['A new programming language', 'Creating solutions using natural language prompts instead of traditional coding', 'A type of database system', 'A testing framework'], 'opts_ar': ['لغة برمجة جديدة', 'إنشاء حلول بأوامر نصية بدلاً من البرمجة التقليدية', 'نوع من أنظمة قواعد البيانات', 'إطار عمل للاختبار'], 'correct': 1},
            {'q': 'What is the core loop of vibe coding?', 'q_ar': 'ما هي الحلقة الأساسية للبرمجة بالوصف؟', 'opts': ['Plan, Code, Test', 'Describe, Generate, Refine', 'Design, Build, Deploy', 'Research, Develop, Publish'], 'opts_ar': ['خطط، برمج، اختبر', 'صف، ولّد، حسّن', 'صمم، ابنِ، انشر', 'ابحث، طوّر، انشر'], 'correct': 1},
            ...
            {'q': 'What is rapid prototyping?', 'q_ar': 'ما هي النمذجة السريعة؟', 'opts': ['Writing code very fast manually', 'Quickly creating working prototypes using AI tools', 'Skipping testing entirely', 'Copying existing applications'], 'opts_ar': ['كتابة الكود بسرعة يدوياً', 'إنشاء نماذج عاملة بسرعة بأدوات الذكاء الاصطناعي', 'تخطي الاختبار تماماً', 'نسخ التطبيقات الموجودة'], 'correct': 1},
            {'q': 'Why is iteration important in vibe coding?', 'q_ar': 'لماذا يعد التكرار مهماً؟', 'opts': ['It is not important', 'It refines prompts and output until the solution meets requirements', 'It makes the process slower', 'It replaces testing'], 'opts_ar': ['ليس مهماً', 'يحسّن الأوامر والمخرجات حتى يلبي الحل المتطلبات', 'يجعل العملية أبطأ', 'يحل محل الاختبار'], 'correct': 1},
        ],
    },
    # ── MODULE 5: Designing AI Automation Solutions ──
    {
        ...
        'slides': [
            ...
            {'id': 'm5-s4', 'title': 'Operational Coordination', 'title_ar': 'التنسيق التشغيلي', 'type': 'content',
             'content_en': '<div class="info-box emerald"><strong>Operational Coordination</strong> — Automation for scheduling, routing, and resource allocation.</div><div class="info-box cyan" style="margin-top:12px"><strong>Healthcare Examples:</strong><ul style="margin:8px 0 0 16px"><li>Automated appointment scheduling and rescheduling</li><li>Routing patient referrals to the right specialist</li><li>Bed management and allocation</li><li>Staff scheduling and shift management</li><li>Supply chain coordination</li></ul></div>',
            ...
            {'id': 'm5-s5', 'title': 'Communication Automation', 'title_ar': 'أتمتة التواصل', 'type': 'content',
             'content_en': '<div class="info-box violet"><strong>Communication Automation</strong> — Automated workflows for reminders, follow-ups, and notifications.</div><div class="info-box cyan" style="margin-top:12px"><strong>Healthcare Examples:</strong><ul style="margin:8px 0 0 16px"><li>Patient follow-up reminders after visits</li><li>Appointment confirmation and reminder notifications</li><li>Lab result availability notifications</li><li>Medication refill reminders</li><li>Post-discharge check-in messages</li></ul></div>',
            ...
            {'id': 'm5-s8', 'title': 'Monitoring & Alerts', 'title_ar': 'المراقبة والتنبيهات', 'type': 'content',
             'content_en': '<div class="info-box slate"><strong>Monitoring & Alerts</strong> — Automated systems that track metrics, detect anomalies, and send alerts.</div><div class="info-box cyan" style="margin-top:12px"><strong>Healthcare Examples:</strong><ul style="margin:8px 0 0 16px"><li>Tracking medication inventory levels</li><li>Patient vital sign monitoring</li><li>Equipment maintenance alerts</li><li>Compliance deadline tracking</li><li>Unusual pattern detection in patient data</li></ul></div>',
            ...
            {'id': 'm5-s9', 'title': 'Automation Tools Overview', 'title_ar': 'نظرة عامة على أدوات الأتمتة', 'type': 'content',
             'content_en': '<div class="info-box cyan"><strong>Practical Automation Tools:</strong></div><div style="margin-top:12px"><div class="info-box emerald" style="margin-bottom:8px"><strong>n8n</strong> — Open-source visual workflow automation platform. Node-based interface, self-hostable for data privacy.</div><div class="info-box violet" style="margin-bottom:8px"><strong>Make (Integromat)</strong> — Visual automation with parallel paths, error handling, and data transformation.</div><div class="info-box amber"><strong>Zapier</strong> — Trigger-based automation connecting 5,000+ apps. Simple if-this-then-that logic, no coding required.</div></div>',
             'content_ar': '<div class="info-box cyan"><strong>أدوات الأتمتة العملية:</strong></div><div style="margin-top:12px"><div class="info-box emerald" style="margin-bottom:8px"><strong>n8n</strong> — منصة أتمتة سير عمل مرئية مفتوحة المصدر.</div><div class="info-box violet" style="margin-bottom:8px"><strong>Make</strong> — أتمتة مرئية مع مسارات متوازية ومعالجة الأخطاء.</div><div class="info-box amber"><strong>Zapier</strong> — أتمتة قائمة على المحفزات تربط أكثر من 5,000 تطبيق.</div></div>'},
            {'id': 'm5-s10', 'title': 'Module 5 Summary & Key Takeaways', 'title_ar': 'ملخص الوحدة الخامسة', 'type': 'summary', 'has_video': True, 'video_type': 'conclusion',
             ...
             'content_ar': '<div class="info-box cyan"><strong>النقاط الرئيسية:</strong><ul style="margin:8px 0 0 16px"><li><strong>تحديد فرص الأتمتة:</strong> المهام المتكررة والمستهلكة للوقت</li><li><strong>عملية التصميم من 5 خطوات</strong></li><li><strong>فئات حالات الاستخدام:</strong> التنسيق التشغيلي، التواصل، دعم القرار، الإنتاجية، المراقبة</li></ul></div>'},
        ],
        'quiz': [
...
print(f"Defined {len(MODULES)} modules")
for m in MODULES:
    print(f"  Module {m['number']}: {m['title']} — {len(m['slides'])} slides, {len(m['quiz'])} quiz questions")

# ══════════════════════════════════════════════════════════════
# CSS STYLES (shared across all packages)
# ══════════════════════════════════════════════════════════════
  ...
  <div class="card">
    <div class="card-header">
      <div>
        ...
        <span class="badge badge-violet" id="badgeSlide">Topic {slide_idx + 1}</span>
      </div>
...
'''
    ...
    # Add video section
    if video_url:
        video_label_en = 'Introduction Video' if slide.get('video_type') == 'intro' else 'Conclusion Video'
        video_label_ar = 'فيديو المقدمة' if slide.get('video_type') == 'intro' else 'فيديو الخاتمة'
        html += f'''
      <div class="section-divider" id="videoLabel">{video_label_en}</div>
...
'''
    ...
    <div class="card-footer">
      <span style="font-size:11px;color:var(--slate)" id="footerInfo">Module {mod_num} of 5 — {mod_title}</span>
'''
...
function toggleLang() {{
  ...
  document.getElementById('badgeSlide').textContent = lang === 'ar' ? 'الموضوع {slide_idx + 1}' : 'Topic {slide_idx + 1}';
...
'''
  ...
  if(vl) vl.textContent = lang === 'ar' ? {json.dumps(video_label_ar)} : {json.dumps(video_label_en)};
'''
...
window.addEventListener('load', () => {{
  ...
  // Mark as completed after 5 seconds (viewed the content)
  setTimeout(() => {{
...
def _build_quiz_js(quiz_questions):
    """Build quiz JavaScript for the slide."""
    q_json = json.dumps(quiz_questions)
    return f'''
const QUIZ_DATA = {q_json};
let quizAnswers = {{}};
...
function renderQuiz() {{
  const qs = document.getElementById('quizSection');
  let h = '<div class="section-divider">' + (lang==='ar'?'اختبار الموضوع':'Topic Quiz') + '</div>';
  QUIZ_DATA.forEach((q, i) => {{
    const qText = lang==='ar' ? q.q_ar : q.q;
    const opts = lang==='ar' ? q.opts_ar : q.opts;
  ...
  if (!quizSubmitted) {{
    ...
    const correct = QUIZ_DATA.filter((q,i) => quizAnswers[i] === q.correct).length;
    const pct = Math.round(correct / QUIZ_DATA.length * 100);
    const passed = pct >= 80;
...
def build_packages():
    """Build individual SCORM zip packages for each slide in each module."""
    ...
    for module in MODULES:
        ...
        for slide_idx, slide in enumerate(module['slides']):
            ...
            # Quiz: include quiz on last slide (summary) or if only 1 slide
            is_last = (slide_idx == len(module['slides']) - 1)
            quiz_qs = module['quiz'] if is_last else None
            
            # Build HTML
            html = build_slide_html(module, slide, slide_idx, quiz_qs)
            
            # Build manifest
            safe_title = f"Module {mod_num} - Topic {slide_idx + 1}: {s_title}"
            manifest_id = f"M{mod_num}_Topic{slide_idx + 1}_{s_id.replace('-','_')}"
            manifest = build_manifest(manifest_id, safe_title)
            
            # Create zip
            zip_name = f"m{mod_num}-topic{slide_idx + 1}-{s_id}.zip"
            ...
            has_vid = '📹' if slide.get('has_video') else '  '
            has_quiz = '📝' if quiz_qs else '  '
            has_img = '🖼️' if slide.get('image_key') else '  '
            print(f"  {has_vid}{has_img}{has_quiz} Topic {slide_idx + 1}: {s_title:45s} → {zip_name} ({size_kb:.1f} KB)")
...
def build_tar_gz(all_packages):
    """Build a single tar.gz containing all individual SCORM packages."""
    tar_path = os.path.join(OUTPUT_DIR, 'all-scorm-per-slide.tar.gz')
    ...
    print(f"\n📦 Full archive: all-scorm-per-slide.tar.gz ({size_kb:.1f} KB)")
    return tar_path
...
print("\n🏗️  Building individual SCORM packages per slide...")
all_packages = build_packages()

print(f"\n📊 Summary:")
total_packages = len(all_packages)
total_size = sum(p['size_kb'] for p in all_packages)
video_count = sum(1 for p in all_packages if p['has_video'])
quiz_count = sum(1 for p in all_packages if p['has_quiz'])
image_count = sum(1 for p in all_packages if p['has_image'])
print(f"  Total packages: {total_packages}")
print(f"  Total size: {total_size:.1f} KB")
print(f"  With videos: {video_count}")
print(f"  With quizzes: {quiz_count}")
...
for pkg in all_packages:
    if pkg['module'] != current_mod:
        ...
        print(f"  {'─'*60}")
    v = '📹' if pkg['has_video'] else '  '
    q = '📝' if pkg['has_quiz'] else '  '
    print(f"    {v}{q} Topic {pkg['topic']:2d}: {pkg['title']}")

# Build tar.gz
tar_path = build_tar_gz(all_packages)

print(f"\n✅ All {total_packages} SCORM packages built successfully!")
